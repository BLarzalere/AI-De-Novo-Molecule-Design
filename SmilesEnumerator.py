...
if __name__ == "__main__":
    ...
    if len(set(transformed)) > 2: print
    "Too many different canonical SMILES generated"
    ...
    if len(set(transformed)) < 3: print
    "Too few enumerated SMILES generated"
    ...
    for i, smile in enumerate(reconstructed):
        if smile != smiles[i]:
            print
            "Error in reconstruction %s %s" % (smile, smiles[i])
            break
    ...
    if v.shape != (20, 52, 18): print
    "Possible error in pandas use"
